...
\subsection*{Key Performance (LC VCO)}
\begin{table}[H]
  \centering
  \begin{tabular}{lll}
    \toprule
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xlabel={$V_{ctrl}$ (V)}, ylabel={$f$ (MHz)}, grid=both]
      \addplot[green!60!black, thick, mark=square*] table [col sep=comma, x=Vctrl, y expr=\thisrow{freq}/1e6] {EE5295_Sim_Scaffold/spice/results/lc_vco_fv.csv};
    \end{axis}
  \end{tikzpicture}
